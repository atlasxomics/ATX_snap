...
def snap_workflow(
    ...
    * spatial_dim_*.png: Spatial scatter plot pages for each Run colored by cluster; see [`squidpy.pl.spatial_scatter`](https://squidpy.readthedocs.io/en/stable/api/squidpy.pl.spatial_scatter.html#squidpy.pl.spatial_scatter).
    * spatial_qc_*.png: Spatial scatter plot pages for each Run colored by number of fragments, log10(number of fragments), and TSS Enrichment score; see [`squidpy.pl.spatial_scatter`](https://squidpy.readthedocs.io/en/stable/api/squidpy.pl.spatial_scatter.html#squidpy.pl.spatial_scatter).
    ...
    * umap.html, spatial_dim.html, spatial_qc.html: Top-level HTML galleries for the Python-generated figure outputs.
