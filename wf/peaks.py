...
import wf.MACS3_GPU.MACS_GPU as MP
...
def call_peaks_macs3_gpu(
    ...
    """
    Wrapper around MACS_GPU function, peak caller routine implemented for identifying peaks,
    ...
    for f in fragments:
        ...
        for cluster in fragments[f]:
            d, num_reads = MP.Load_BedFile_df(cluster)
            peaks = MP.MACS_GPU(
                d=d,
                num_reads=num_reads,
                d_treat=d_treat,
